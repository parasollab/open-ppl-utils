...
namespace nonstd {
  ...
  listener(tcp_socket* _t)
  {
    ...
    while(true) {
      ...
      socklen_t addr_length = sizeof(info);
  ...
  print_error() {
    switch(errno) {
      ...
      case EFAULT:
        return "Cannot write socket address info.";
      case EINTR:
        return "Interrupted by signal.";
      case EINVAL:
        return "Socket not listening or address length invalid.";
      case EMFILE:
        return "Process cannot create additional file descriptors.";
      case ENFILE:
        return "System cannot create additional file descriptors.";
      case ENOBUFS:
      case ENOMEM:
      ...
      case EPROTO:
        return "TCP error.";
      case EPERM:
        return "Connection blocked by firewall.";
      default:
