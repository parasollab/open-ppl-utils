...
!     ************
      ...
      integer   l1,l2,l3,lws,lr,lz,lt,ld,lsg,lwa,lyg,lsgo,lwy,lsy,lss,lyy,lwt,lwn,lsnd,lygo
...
!
!       Linpack Library ... dcopy_lbfgsb, ddot_lbfgsb.
!
!
!     References:
!
...
!quark8 1
      ...
      double precision theta,fold,ddot_lbfgsb,dr,rr,tol,dpmeps,&
...
!                                          restore the previous iterate.
               call dcopy_lbfgsb(n,t,1,x,1)
               call dcopy_lbfgsb(n,r,1,g,1)
               f = fold
            endif
            goto 999
         endif
...
!                                            skip the search for GCP.
         call dcopy_lbfgsb(n,x,1,z,1)
	 wrk = updatd
         nint = 0
         goto 333
      endif
!write(*,*) 'que el ala del viento sea contigo! '
...
!
!       Linpack ... dscal_lbfgsb dcopy_lbfgsb, daxpy_lbfgsb.
!
!
!     References:
!
...
!     ************
      ...
      double precision f1,f2,dt,dtm,tsum,dibp,zibp,dibp2,bkmin,&
                      tu,tl,wmc,wmp,wmw,ddot_lbfgsb,tj,tj0,neggi,sbgnrm,&
                      f2_org
      double precision one,zero
      parameter        (one=1.0d0,zero=0.0d0)
...
!                   complete the initialization of p for theta not= one.
         call dscal_lbfgsb(col,theta,p(col+1),1)
      endif
...
!        temporarily set f1 and f2 for col=0.
      ...
      if (col .gt. 0) then
!                          update c = c + dt*p.
	 call daxpy_lbfgsb(col2,dt,p,1,c,1)
...
!           update p = p - dibp*wbp. 
       	 call daxpy_lbfgsb(col2,-dibp,wbp,1,p,1)
...
!       the variables whose breakpoints haven't been reached.
      ...
      call daxpy_lbfgsb(n,tsum,d,1,xcp,1)
...
!       which will be used in computing r = Z'(B(x^c - x) + g).
      ...
      if (col .gt. 0) call daxpy_lbfgsb(col2,dtm,p,1,c,1)
      if (iprint .gt. 100) write (6,1010) (xcp(i),i = 1,n)
...
!     Subprograms called:
!
!       Linpack ... dcopy_lbfgsb, dpofa, dtrsl.
!
!
!     References:
!       [1] R. H. Byrd, P. Lu, J. Nocedal and C. Zhu, ``A limited
...
!     ************
      ...
      double precision ddot_lbfgsb,temp1,temp2,temp3,temp4
      double precision one,zero
      parameter        (one=1.0d0,zero=0.0d0)
...
!                                 shift old part of WN1.
            do 10 jy = 1, m - 1
               js = m + jy
	       call dcopy_lbfgsb(m-jy,wn1(jy+1,jy+1),1,wn1(jy,jy),1)
 	       call dcopy_lbfgsb(m-jy,wn1(js+1,js+1),1,wn1(js,js),1)
 	       call dcopy_lbfgsb(m-1,wn1(m+2,jy+1),1,wn1(m+1,jy),1)
  10        continue
         endif
...
!     **********
      ...
      integer          i
      double           precision ddot_lbfgsb,a1,a2
...
!     Determine the maximum step length.
  ...
  43        continue
	 ...
	 stp = one
      ...
      call dcopy_lbfgsb(n,x,1,t,1)
      call dcopy_lbfgsb(n,g,1,r,1)
      fold = f
      ifun = 0
      iback = 0
      csave = 'START'
...
!     Subprograms called:
!
!       Linpack ... dcopy_lbfgsb, ddot_lbfgsb.
!
!
!                           *  *  *
!
...
!     Update matrices WS and WY.
      ...
      call dcopy_lbfgsb(n,d,1,ws(1,itail),1)
      call dcopy_lbfgsb(n,r,1,wy(1,itail),1)
...
!                              move old information
         do 50 j = 1, col - 1
            call dcopy_lbfgsb(j,ss(2,j+1),1,ss(1,j),1)
            call dcopy_lbfgsb(col-j,sy(j+1,j+1),1,sy(j,j),1)
  50     continue
      endif
...
!quark:    MUST FIND TIMER ROUTINES IN LINUX!
!     temp = etime(tarray) 
!      temp = 0.
...
!====================== The end of timer ===============================
      ...
      double precision function dnrm2_lbfgsb(n,x,incx)
      integer n,incx
      double precision x(n)
!     **********
!
!     Function dnrm2_lbfgsb
!
...
!     **********
   ...
   10 continue
      ...
      do 20 i = 1, n, incx
         dnrm2_lbfgsb = dnrm2_lbfgsb + (x(i)/scale)**2
   20 continue

      dnrm2_lbfgsb = scale*sqrt(dnrm2_lbfgsb)
...
!     *******
    ...
    double precision a,b,beta,betain,betah,temp,tempa,temp1,zero,one,two
...
!====================== The end of dpmeps ==============================
      ...
      subroutine daxpy_lbfgsb(n,da,dx,incx,dy,incy)
!
!     constant times a vector plus a vector.
!     uses unrolled loops for increments equal to one.
!     jack dongarra, linpack, 3/11/78.
!
      double precision dx(1:n),dy(1:n),da
...
!====================== The end of daxpy_lbfgsb ===============================

      subroutine dcopy_lbfgsb(n,dx,incx,dy,incy)
!
...
!====================== The end of dcopy_lbfgsb ===============================

      double precision function ddot_lbfgsb(n,dx,incx,dy,incy)
!
...
! quark
      integer i,incx,incy,ix,iy,m,mp1,n
      double precision dx(1:n),dy(1:n),dtemp
!
      ddot_lbfgsb = 0.0d0
      dtemp = 0.0d0
      if(n.le.0)return
...
!
   ...
   50 continue
   60 ddot_lbfgsb = dtemp
      return
      end
      
!====================== The end of ddot_lbfgsb ================================
...
!     internal variables
!
      double precision ddot_lbfgsb,t
      double precision s
      integer j,jm1,k
...
!====================== The end of dpofa ===============================
      ...
      subroutine  dscal_lbfgsb(n,da,dx,incx)
!
...
!====================== The end of dscal_lbfgsb ===============================

      subroutine dtrsl(t,ldt,n,b,job,info)
      integer ldt,n,job,info
      double precision t(ldt,1:n),b(1:n)
!
!
...
!     subroutines and functions
!
!     blas daxpy_lbfgsb,ddot_lbfgsb
!     fortran mod
!
!     internal variables
!
      double precision ddot_lbfgsb,temp
      integer case,j,jj
!
...
!
   20    continue
            ...
            do 30 j = 2, n
               temp = -b(j-1)
               call daxpy_lbfgsb(n-j+1,temp,t(j,j-1),1,b(j),1)
               b(j) = b(j)/t(j,j)
   30       continue
   40       continue
         go to 140
...
!
   50    continue
            ...
            do 60 jj = 2, n
               j = n - jj + 1
               temp = -b(j+1)
               call daxpy_lbfgsb(j,temp,t(1,j+1),1,b(1),1)
               b(j) = b(j)/t(j,j)
   60       continue
   70       continue
         go to 140
