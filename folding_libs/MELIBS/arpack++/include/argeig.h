  ...
  while (!this->BasisOK) {
    ...
    case -1:
      ...
      if (this->mode != 2) {
        ...
        (objB->*MultBx)(&this->workd[this->ipntr[1]],&this->workd[this->ipntr[3]]);
      }
    ...
    case  1:
      ...
      if (this->mode == 2) { // w = x if mode = 2.
        (*this->objOP->MultOPx)(&this->workd[this->ipntr[1]],&this->workd[this->ipntr[2]]);
      }
      else {           // w = B*x otherwise.
        (*this->objOP->MultOPx)(&this->workd[this->ipntr[3]],&this->workd[this->ipntr[2]]);
      }
      break;
    ...
    case  2:
      ...
      (objB->*MultBx)(&this->workd[this->ipntr[1]],&this->workd[this->ipntr[2]]);
