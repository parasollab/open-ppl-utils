...
*/  
    ...
    */
    ...
    void Matrix3x3::set(double a11, double a12, double a13,
        ...
        double a31, double a32, double a33)
    {
        double r0[3]={a11, a12, a13};
        double r1[3]={a21, a22, a23};
        double r2[3]={a31, a32, a33};
    ...
    void Matrix4x4::set(double a11, double a12, double a13, double a14,
        ...
        double a41, double a42, double a43, double a44)
    {
        double r0[4]={a11, a12, a13, a14};
        double r1[4]={a21, a22, a23, a24};
        double r2[4]={a31, a32, a33, a34};
        double r3[4]={a41, a42, a43, a44};
