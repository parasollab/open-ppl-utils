#ifndef STD_INPUT_MANAGER_H_
#define STD_INPUT_MANAGER_H_
...
////////////////////////////////////////////////////////////////////////////////
/// Manages user input on behalf of the gl_widget. Manages keyboard, mouse, and
/// tablet input. Any new controllers should forward their events here.
////////////////////////////////////////////////////////////////////////////////
  ...
  : public QWidget
{
  ...
  protected:
    ...
    gl_widget* const m_gl;    ///< A pointer to the parent gl_widget.
  ...
  public:
    ...
    virtual ~std_input_manager() = default;
