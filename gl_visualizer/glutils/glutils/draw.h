...
namespace glutils {
  ...
  namespace draw {
    ...
    void
    circle(const GLfloat _radius, const size_t _segments = 20);
    ...
    /// @param[in] _segments The number of segments to use.
    void
    circle_frame(const GLfloat _radius, const size_t _segments = 20);
    ...
    /// @param[in] _segments The number of segments to use.
    void
    sphere(const GLfloat _radius, const size_t _segments = 20);
    ...
    /// @param[in] _segments The number of segments to use.
    void
    sphere_frame(const GLfloat _radius, const size_t _segments = 20);
