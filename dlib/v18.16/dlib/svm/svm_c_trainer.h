...
// ----------------------------------------------------------------------------------------
    ...
    public:
        ...
        template <
            ...
            >
        std::pair<const decision_function<kernel_type>,
    ...
    // ------------------------------------------------------------------------------------
        ...
        ) const
        {
            ...
            solver(symmetric_matrix_cache<double>((diagm(y)*kernel_matrix(kernel_function,x)*diagm(y)), cache_size),
            ...
            return std::make_pair(decision_function<K>(sv_alpha, b, kernel_function, support_vectors), alpha);
        }
